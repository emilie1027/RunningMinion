...
from utils import DQNAgent, ReplayMemory, loop_play_forever
...
class Agent(DQNAgent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.state_shape = np.prod((self.num_frames,) + self.state_dim)
        self.input_shape = (self.batch_size, self.state_shape)
